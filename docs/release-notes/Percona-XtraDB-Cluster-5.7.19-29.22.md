...
* [Percona Server 5.7.19-17](http://www.percona.com/doc/percona-server/5.7/release-notes/Percona-Server-5.7.19-17.html)
...
* [PXC-803](https://jira.percona.com/browse/PXC-803): Added support for new features in Percona XtraBackup 2.4.7:
    ...
    * [`encrypt_threads`](../manual/xtrabackup_sst.md#cmdoption-arg-encrypt_threads) specifies the number of threads
...
This value is passed using the `--encrypt-threads` option in XtraBackup.
    ...
    * [`backup_threads`](../manual/xtrabackup_sst.md#cmdoption-arg-backup_threads) specifies the number of threads
...
* [PXC-851](https://jira.percona.com/browse/PXC-851): Added version compatibility check during SST
with XtraBackup:
...
**NOTE**: As part of fix for [PXC-827](https://jira.percona.com/browse/PXC-827),
