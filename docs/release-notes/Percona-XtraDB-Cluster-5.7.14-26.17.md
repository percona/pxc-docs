...
* [Percona Server 5.7.14-8](http://www.percona.com/doc/percona-server/5.7/release-notes/Percona-Server-5.7.14-8.html)
...
This is a list of the most important features introduced in Percona XtraDB Cluster 5.7
compared to version 5.6


* [PXC Strict Mode](../features/pxc-strict-mode.md#pxc-strict-mode) saves your workload
...
Fixed setting of `seqno` in `grastate.dat` to `-1`
on clean shutdown.
...
Added support of [`defaults-group-suffix`](http://dev.mysql.com/doc/refman/5.7/en/option-file-options.html#option_general_defaults-group-suffix) for SST scripts.
