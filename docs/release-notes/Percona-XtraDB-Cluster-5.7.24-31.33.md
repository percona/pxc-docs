...
```
 ...
 was used to turn on transparent handling of
...
```
 ...
 usage to make *InnoDB* avoid writes during
...
```
:variable:`binlog_format=STATEMENT`
```
...
* [PXC-2269](https://jira.percona.com/browse/PXC-2269): being not dynamic, the
...
```
 ...
 variable was erroneously allowed to
be changed by a `SET GLOBAL` statement.


* [PXC-2275](https://jira.percona.com/browse/PXC-2275): checking 
