...
* [Percona Server 5.7.18-15](http://www.percona.com/doc/percona-server/5.7/release-notes/Percona-Server-5.7.18-15.html)
...
* [PXC-749](https://jira.percona.com/browse/PXC-749): Fixed memory leak when running `INSERT`
...
* [PXC-812](https://jira.percona.com/browse/PXC-812): Fixed SST script to leave the DONOR keyring
...
* [PXC-816](https://jira.percona.com/browse/PXC-816): Fixed hook for caching GTID events
in asynchronous replication.
For more information, see [#1681831](https://bugs.launchpad.net/percona-xtradb-cluster/+bug/1681831).


* [PXC-820](https://jira.percona.com/browse/PXC-820): Enabled querying of 
...
* [PXC-823](https://jira.percona.com/browse/PXC-823): Fixed SST flow to gracefully shut down JOINER node
...
* [PXC-824](https://jira.percona.com/browse/PXC-824): Fixed graceful shutdown of Percona XtraDB Cluster node
...
to expose required values from 
