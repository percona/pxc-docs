...
because the regression introduced in Percona XtraDB Cluster 
...
* [PXC-911](https://jira.percona.com/browse/PXC-911): When node’s own IP address was defined in the
...
```
 ...
 variable, the node was receiving
