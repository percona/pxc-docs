...
* [PXC-4284](https://jira.percona.com/browse/PXC-4284): If a MySQL user was not created before the GRANT option, the Percona XtraDB Cluster node was disconnected and needed a complete state transfer ([SST](..//glossary.md#state-snapshot-transfer-sst)).
