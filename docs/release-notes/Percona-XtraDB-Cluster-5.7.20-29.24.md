...
Binaries are available from the [downloads section](http://www.percona.com/downloads/Percona-XtraDB-Cluster-57/)
...
* [PXC-866](https://jira.percona.com/browse/PXC-866): a new variable 
...
```
 ...
 one, was introduced to clearly
separate last committed and last applied transaction numbers.


* [PXC-868](https://jira.percona.com/browse/PXC-868): on the Joiner, during SST, 
...
* [PXC-889](https://jira.percona.com/browse/PXC-889): fixed an issue where a node with an invalid value for
...
```
 ...
 was allowed to start up and operate in standalone
...
* [PXC-867](https://jira.percona.com/browse/PXC-867): `wsrep_sst_rsync` script was overwriting
...
```
 ...
 configuration setting making it not to be taken
into account.
...
* [PXC-875](https://jira.percona.com/browse/PXC-875): fixed an issue where toggling 
...
Bug fixed [#1700593](https://bugs.launchpad.net/percona-xtradb-cluster/+bug/1700593)
...
* [PXC-897](https://jira.percona.com/browse/PXC-897): fixed empty 
...
* [PXC-915](https://jira.percona.com/browse/PXC-915): suppressing DDL/TOI replication in case of
...
```
 ...
 zero value didn’t work when DDL statement was
