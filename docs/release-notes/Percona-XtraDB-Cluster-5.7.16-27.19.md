...
* [Percona Server 5.7.16-10](http://www.percona.com/doc/percona-server/5.7/release-notes/Percona-Server-5.7.16-10.html)
...
* [PXC-731](https://jira.percona.com/browse/PXC-731): Changed the 
...
([`encrypt`](../manual/xtrabackup_sst.md#cmdoption-arg-encrypt) set to `2`, `3` or `4`),
