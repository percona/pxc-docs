...
and on the [download page](http://www.percona.com/downloads/Percona-XtraDB-Cluster-57/LATEST/).
...
**NOTE**: The [SELinux](https://selinuxproject.org) security module
...
4. Copy the automatically generated temporary password
