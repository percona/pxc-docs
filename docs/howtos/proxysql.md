...
**NOTE**: For more information about ProxySQL, see [ProxySQL documentation](https://proxysql.com/documentation/).
...
that you creted in Creating ProxySQL Client User.
...
This mode is controlled using the 
...
which is determined by the value of the 
