# Quickstart Guide for Percona XstraDB Cluster
...
## Installing and starting Percona XstraDB Cluster

You can install Percona XstraDB Cluster using different methods. 
