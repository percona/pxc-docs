...
> - Feature ported from the *Facebook MySQL* patch.
...
> 
> * [Making full table scan 10x faster in InnoDB](http://yoshinorimatsunobu.blogspot.hr/2013/10/making-full-table-scan-10x-faster-in.html)
