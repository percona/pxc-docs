...
3. Select the required product in `Select Product`, for example, Percona XtraDB Cluster 8.0.
4. Select your distribution version in the `Select Product Version` dropdown, for example, `Percona-XtraDB-Cluster-8.0.41`.
