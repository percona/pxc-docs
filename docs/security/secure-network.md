...
and [SST](../glossary.md#term-SST) (State Snapshot Transfer) via `mysqldump`.


* 4444 is used for [SST](../glossary.md#term-SST) via `rsync`
and [Percona XtraBackup](../manual/xtrabackup_sst.md#xtrabackup-sst).
...
* 4568 is used for [IST](../glossary.md#term-IST) (Incremental State Transfer).
