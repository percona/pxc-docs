...
machine replication with strong coordination between servers :octicons-link-external-16:](https://dev.mysql.com/doc/refman/{{vers}}/en/group-replication.html). It is
